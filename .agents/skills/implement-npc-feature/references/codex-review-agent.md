...
1. read the review skill, `ProjectStructure.md`, the Systems leaf documents that own the changed files, and only the applicable shared architecture/convention documents;
...
- Let the launcher, not the agent, write the final response to `PublicMD/Status/Code_Evaluation_Result.md`.
